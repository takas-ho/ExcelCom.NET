...
Namespace Core
    ...
    Public MustInherit Class ChartObjectTest
        ...
        'Public Class CellsTest : Inherits ChartObjectTest
        ...
        Public Class ExcelObjectたちTest : Inherits ChartObjectTest

            <Test()> Public Sub Chartが閉じられること()
                Dim value As Chart = sheet.ChartObjects.Add(2, 3, 4, 5).Chart
        ...
        Public Class PropertyたちTest : Inherits ChartObjectTest
